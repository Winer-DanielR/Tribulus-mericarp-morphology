...
biplot2 <- fviz_pca_biplot(mericarp_size_pca,
                           ...
                           pointsize = 4,
                           stroke = 0.5,
                           fill.ind = mericarp_NA_wozero$Herb_Location,
                           col.ind = "black",
