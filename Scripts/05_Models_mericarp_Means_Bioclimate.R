...
EM_length_bioclim <- emmeans(ind_length_m1, ~ mainland_island)
...
EM_width_bioclim <- emmeans(ind_width_m3, ~ mainland_island)

### Emmean plot: Width ####
plot(EM_width_bioclim, comparisons = TRUE) + labs(title = "Mericarp Width")
...
EM_depth_bioclim <- emmeans(ind_depth_m1, ~ mainland_island)
### Emmeans plot: Depth ####
...
# Zero filter data
EM_tip_dist_bioclim <- emmeans(ind_tip_distance_m1, ~ mainland_island)
