...
table18 <- (Anova(meri_lower_spines_m2))
...
```{r Model 1 mericarp PCA biplot, echo=FALSE, fig.align='right', fig.height=8, fig.width=8, warning=FALSE, results='asis'}
...
biplot1  <- fviz_pca_biplot(mericarp_pca, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Model 1: Mericarps PCA") + scale_color_manual(values = c("#FFB90F", "#006400")) + theme_transparent() + theme(
                  ...
                  legend.background = element_rect(fill = NA, size = 0)) + theme(plot.title = element_text(hjust = 0)) + ylim(-4.5, 4.5) + xlim(-4,6)
...
```{r Model 1 PCA Leaf, echo=FALSE, fig.align='right', fig.height=8, fig.width=8, results='asis'}
...
biplot2  <- fviz_pca_biplot(leaf_pca, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Model 1: Leaf PCA") + scale_color_manual(values = c("#FFB90F", "#006400")) + theme_transparent() + theme(
                  legend.position = "bottom",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.text = element_text(size = 12, face = "bold"), 
                  legend.title = element_text(size = 14, face = "bold"), 
                  legend.background = element_rect(fill = NA, size = 0)) + theme(plot.title = element_text(hjust = 0)) + ylim(-4.5, 4.5)
...
```{r Model 1 biplots all, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r Model 2 leaf PCA biplot, echo=F, fig.align='right', fig.height=8, fig.width=8, results='asis'}
...
biplot3  <- fviz_pca_biplot(leaf_pca_model2, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Model 2: Leaf PCA") + scale_color_manual(values = c("#9B30FF", "#4876FF")) + theme_transparent() + theme(
                  legend.position = "bottom",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.text = element_text(size = 12, face = "bold"), 
                  legend.title = element_text(size = 14, face = "bold"), 
                  legend.background = element_rect(fill = NA, size = 0)) + theme(plot.title = element_text(hjust = 0))
...
```{r Model 3 mericarp PCA biplot, echo=FALSE, fig.align='right', fig.height=8, fig.width=8, results='asis'}
#Biplot
biplot4  <- fviz_pca_biplot(mericarp_pca_model3, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Model 3: Mericarp PCA") + scale_color_manual(values = c("dark red", " blue")) + theme_transparent() + theme(
                  legend.position = "bottom",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.text = element_text(size = 12, face = "bold"), 
                  legend.title = element_text(size = 14, face = "bold"), 
                  legend.background = element_rect(fill = NA, size = 0)) + theme(plot.title = element_text(hjust = 0)) + ylim(-3.5,3.5) + xlim(-5.5,5.5)
...
```{r Model 3 leaf PCA biplot, echo=FALSE, fig.align='right', fig.height=8, fig.width=8, results='asis'}
...
biplot5  <- fviz_pca_biplot(leaf_pca_model3, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Model 2: Leaf PCA") + scale_color_manual(values = c("dark red", " blue")) + theme_transparent() + theme(
                  legend.position = "bottom",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
...
```{r Model 3 biplots all, eval=FALSE, include=FALSE}
