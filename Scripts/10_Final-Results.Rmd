...
```{r Univariate Model 1 Mericarps, echo=FALSE, fig.cap= "Estimated means of mericarp traits between island and mainland populations.", fig.height=6}
...
```{r Univariate Model 1 Leaf, echo=FALSE, fig.cap= "Estimated means of leaf traits between island and mainland populations.", fig.width= 10, fig.height=3}
...
```{r Univariate Model 2 Leaf, echo=FALSE, fig.cap= "Estimated means of leaf traits between the Galapagos and other island populations.", fig.width= 10, fig.height=3}

figure_leaf_model2 <- ggarrange(ggplot_flower2,
                                ggplot_leaf2,
                                    ggplot_leaflet2,
                                    ggplot_leaflet_num2,
                                    labels = c("A", "B", "C", "D"),
...
```{r Univariate Model 3 Leaf, echo=FALSE, fig.cap= "Estimated means of leaf traits between finch beak communities. 1 = Presence of large finch species, *Geospiza magnirrostris* and *Geospiza cornirostris*. 0 = Absence of large finch species.", fig.width= 10, fig.height= 3}

figure_leaf_model3 <- ggarrange(ggplot_flower3,
                                ggplot_leaf3,
                                    ggplot_leaflet3,
                                    ggplot_leaflet_num3,
                                    labels = c("A", "B", "C", "D"),
...
knitr::kable(anova_tables, format = "html")
...
```{r Model 1 mericarp PCA biplot, echo=FALSE, fig.align='right', fig.height=6, fig.width=5, warning=FALSE, results='asis'}
...
biplot1  <- fviz_pca_biplot(mericarp_pca, repel = T,
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Mericarps") + scale_color_manual(values = c("#85c0f9", "#0f2080")) + theme_transparent() + theme(
                  legend.position = "top",
                  ...
                  plot.title = element_text(size = 18, vjust = 2.5),
                  legend.text = element_text(size = 12, face = "bold"), 
                  legend.title = element_text(size = 14, face = "bold"), 
                  legend.background = element_rect(fill = NA, size = 0)) + 
  theme(plot.title = element_text(hjust = 0),
        text = element_text(family = "Noto Sans", face = "bold")) + ylim(-4.5, 4.5) + xlim(-4,6)

# var1 <- fviz_pca_var(mericarp_pca,
#              col.var = "contrib",
#              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
#              repel = TRUE 
#              ) +labs(title = "Variables - Model 1: PCA Mericarps")
...
```{r Model 1 PCA Leaf, echo=FALSE, fig.align='right', fig.height=5, fig.width=5, results='asis'}

#Biplot
biplot2  <- fviz_pca_biplot(leaf_pca, repel = T,
                geom = c("point"),
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Leaves") + scale_color_manual(values = c("#85c0f9", "#0f2080")) + theme_transparent() + theme(
                  legend.position = "top",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.background = element_rect(fill = NA, size = 0)) + 
  theme(plot.title = element_text(hjust = 0),
        text = element_text(family = "Noto Sans", face = "bold")) + ylim(-4.5, 4.5)


# # Variables
# var2 <- fviz_pca_var(leaf_pca,
#              col.var = "contrib",
#              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
#              repel = TRUE 
# )
...
```{r Model 1 biplots all, echo=FALSE, fig.align='left', fig.height=8, fig.width=13, warning=FALSE}
...
```{r Model 2 leaf PCA biplot, echo=F, fig.align='right', fig.height=5, fig.width=5, results='asis'}

#Biplot
biplot3  <- fviz_pca_biplot(leaf_pca_model2, repel = T,
                geom = c("point"),
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Leaves") + scale_color_manual(values = c("#f5793a", "#a95aa1")) + theme_transparent() + theme(
                  legend.position = "top",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.background = element_rect(fill = NA, size = 0)) + 
  theme(plot.title = element_text(hjust = 0),
        text = element_text(family = "Noto Sans", face = "bold"))


# # Variables
# var3 <- fviz_pca_var(leaf_pca_model2,
#              col.var = "contrib",
#              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
#              repel = TRUE 
# )
...
#Biplot
biplot4  <- fviz_pca_biplot(mericarp_pca_model3, repel = T,
                geom = c("point"),
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Mericarps") + scale_color_manual(values = c("#0f2080", "#a95aa1")) + theme_transparent() + theme(
                  legend.position = "top",
                  axis.line = element_line(size = 1.2, linetype = "solid"), 
                  axis.ticks = element_line(size = 1), 
                  axis.title = element_text(size = 14), 
                  ...
                  legend.title = element_text(size = 14, face = "bold"), 
                  legend.background = element_rect(fill = NA, size = 0),
                  text = element_text(family = "Noto Sans", face = "bold")) + theme(plot.title = element_text(hjust = 0)) + ylim(-3.5,3.5) + xlim(-5.5,5.5)

# # Variables
# var4 <- fviz_pca_var(mericarp_pca_model3,
#              col.var = "contrib",
#              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
#              repel = TRUE 
# )
...
#Biplot
biplot5  <- fviz_pca_biplot(leaf_pca_model3, repel = T,
                geom = c("point"),
                ...
                pointsize = 2.5,
                ellipse.level = 0.95,
                title = "Leaves") + scale_color_manual(values = c("#0f2080", "#a95aa1")) + theme_transparent() + theme(
...
# # Variables
# var5 <- fviz_pca_var(leaf_pca_model3,
#              col.var = "contrib",
#              gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
#              repel = TRUE 
# )
...
```{r Model 3 biplots all, echo=FALSE, fig.align='left', fig.height=8, fig.width=12}
