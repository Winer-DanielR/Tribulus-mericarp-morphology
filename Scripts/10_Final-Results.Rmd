...
```{r Univariate Model 1 Leaf, echo=FALSE, fig.cap= "Estimated means of leaf traits between island and mainland populations.", fig.height=6}
...
```{r Model 1 mericarp PCA biplot, echo=FALSE, fig.align='right', fig.height=6, fig.width=9, warning=FALSE, results='asis'}

biplot1 <- fviz_pca_biplot(mericarp_pca,
