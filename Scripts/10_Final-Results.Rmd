...
knitr::opts_chunk$set(include = T, message = TRUE)
...
```{r Violin plots, echo=FALSE, fig.cap="Estimated means of mericarp traits between island and mainland populations.", fig.height=6, warning=TRUE}
