# Script 03.Univariate models with year and bioclimate variables as covariate ####
...
# 03_02 Mainland-Galapagos analysis for mericarps ####
# This analysis is for the Galapagos - mainland comparisons

# 03_02_01 Model 1: Mainland - Galapagos ####
## Length ####
# For length, the untransformed data seems the best
### Raw data ####
...
# 03_03 Model 2: Galapagos - Other Islands ####
...
### Percentage difference ####
((8.96/8.22 - 1)*100) # Mericarps ~ 6.66% more separated on islands
